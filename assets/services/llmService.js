...
${businessUnit.selectedDepartmentContext}` : ''
  ...
  async function buildGuidedScenarioDraft(input = {}) {
    return _postServerAiWorkflow(_getScenarioDraftUrl(), {
      ...
      buyerEconomics: input?.buyerEconomics && typeof input.buyerEconomics === 'object' ? input.buyerEconomics : null,
      buyerEconomicsMeta: input?.buyerEconomicsMeta && typeof input.buyerEconomicsMeta === 'object' ? input.buyerEconomicsMeta : null,
      sellerEconomics: input?.sellerEconomics && typeof input.sellerEconomics === 'object' ? input.sellerEconomics : null,
      sellerEconomicsMeta: input?.sellerEconomicsMeta && typeof input.sellerEconomicsMeta === 'object' ? input.sellerEconomicsMeta : null,
      buyerProxyAnswers: input?.buyerProxyAnswers && typeof input.buyerProxyAnswers === 'object' ? input.buyerProxyAnswers : null,
      sellerProxyAnswers: input?.sellerProxyAnswers && typeof input.sellerProxyAnswers === 'object' ? input.sellerProxyAnswers : null,
