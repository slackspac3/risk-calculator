(function(global) {
  ...
  const DOMAIN_CONFIG = Object.freeze({
    ...
    'ai-model-risk': Object.freeze({ label: 'AI / model risk', manualHours: 11, externalDays: 3.25 }),
    'data-governance': Object.freeze({ label: 'Data governance / privacy', manualHours: 10, externalDays: 3.0 }),
    ...
    'fraud-integrity': Object.freeze({ label: 'Fraud / integrity', manualHours: 10, externalDays: 3.0 }),
    ...
    'legal-contract': Object.freeze({ label: 'Legal / contract', manualHours: 10, externalDays: 3.0 }),
    geopolitical: Object.freeze({ label: 'Geopolitical / market access', manualHours: 12, externalDays: 3.25 }),
    ...
    'physical-security': Object.freeze({ label: 'Physical security', manualHours: 9, externalDays: 2.5 }),
    'ot-resilience': Object.freeze({ label: 'OT / site resilience', manualHours: 11, externalDays: 3.0 }),
    'people-workforce': Object.freeze({ label: 'People / workforce', manualHours: 10, externalDays: 2.75 }),
    'investment-jv': Object.freeze({ label: 'Investment / JV', manualHours: 12, externalDays: 3.5 }),
    'transformation-delivery': Object.freeze({ label: 'Transformation delivery', manualHours: 11, externalDays: 3.25 }),
  ...
  const DEFAULT_BENCHMARK_SETTINGS = Object.freeze({
    ...
    externalDayRatesUsd: Object.freeze({
      ...
      cyber: 4600,
      'ai-model-risk': 5000,
      'data-governance': 4500,
      'third-party': 4100,
      regulatory: 4700,
      financial: 4500,
      'fraud-integrity': 4700,
      esg: 4300,
      compliance: 4500,
      'legal-contract': 4900,
      geopolitical: 5000,
      ...
      'physical-security': 3900,
      'ot-resilience': 4600,
      'people-workforce': 4100,
      'investment-jv': 5200,
      'transformation-delivery': 4700,
      hse: 4200,
      general: 4000
    })
  });
  ...
  const DOMAIN_KEYWORDS = Object.freeze({
    ...
    'investment-jv': /\b(merger|acquisition|m&a|joint venture|jv|post-merger|integration thesis|deal value|synergy|divestment)\b/i,
    'transformation-delivery': /\b(transformation delivery|programme delivery|program delivery|project delivery|go-live|milestone|dependency slip|benefit realization|benefit realisation|change programme)\b/i,
    geopolitical: /\b(geopolitical|market access|sanctions|entity list|export control|sovereign|tariff|cross-border restriction|country risk)\b/i,
    ...
    'physical-security': /\b(physical security|facilities|perimeter|executive protection|visitor management|badge control|site access|facility breach)\b/i,
    'ot-resilience': /\b(ot|operational technology|ics|scada|industrial control|plant network|site systems|control room)\b/i,
    ...
    'ai-model-risk': /\b(ai|model risk|responsible ai|machine learning|llm|algorithm|hallucination|bias|model drift|ai act)\b/i,
    'data-governance': /\b(data governance|data quality|lineage|retention|purpose limitation|privacy|personal data|consent|data residency|master data)\b/i,
    ...
    'fraud-integrity': /\b(fraud|financial crime|money laundering|kickback|bribery|corruption|integrity|embezzlement|collusion)\b/i,
    ...
    'legal-contract': /\b(legal|contract|litigation|indemnity|ip\b|intellectual property|licensing dispute|terms breach|dispute)\b/i,
    ...
    'people-workforce': /\b(workforce|labou?r|staffing|fatigue|attrition|strike|worker welfare|contractor welfare|human rights)\b/i,
