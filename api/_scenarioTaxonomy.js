...
const SCENARIO_TAXONOMY_VERSION = 'phase1.1-2026-04-04';
...
const SCENARIO_TAXONOMY_MECHANISMS = Object.freeze([
  ...
  mechanism({
    ...
    positiveSignals: [signal('industrial control instability', 'strong'), signal('control room instability', 'strong'), signal('ics outage', 'strong'), signal('scada disruption', 'strong')],
    examplePhrases: ['ICS instability disrupts site operations', 'control-room instability creates OT resilience pressure']
  })
]);
...
const BASE_SCENARIO_TAXONOMY_FAMILIES = Object.freeze([
  ...
  family({
    ...
    antiSignals: [signal('shipment delay', 'strong'), signal('logistics disruption', 'strong'), signal('greenwashing', 'medium'), signal('weak supplier governance', 'medium'), signal('vendor control gap', 'medium')],
    requiredSignals: [signal('vendor', 'weak'), signal('third-party', 'weak'), signal('supplier', 'weak'), signal('partner', 'weak'), signal('support account', 'weak')],
  ...
  family({
    ...
    positiveSignals: ['process breakdown', 'workflow failure', 'process failed', 'operational breakdown', 'manual processing error', 'human error disrupts'],
    ...
    defaultMechanisms: ['manual_processing_error'],
  ...
  family({
    ...
    positiveSignals: ['service delivery failure', 'service failure', 'critical service disruption', 'service degradation', 'capacity shortfall', 'insufficient capacity', 'throughput constraint', 'resource bottleneck'],
    ...
    defaultMechanisms: ['capacity_constraint'],
    allowedSecondaryFamilies: ['process_breakdown', 'critical_service_dependency_failure'],
  ...
  family({
    ...
    positiveSignals: ['recovery coordination failure', 'recovery effort breaks down', 'restoration delayed', 'recovery team not aligned', 'crisis escalation', 'major incident escalation', 'crisis management'],
  ...
  family({
    ...
    requiredSignals: ['privacy', 'data protection', 'lawful basis', 'processing', 'retention', 'personal data'],
  ...
  family({
    ...
    priorityScore: 77,
    positiveSignals: ['cross-border transfer', 'international transfer restriction', 'data transfer obligations', 'transfer without safeguards', 'transfer impact assessment missing', 'data residency breach'],
    antiSignals: PRIVACY_ANTI,
  ...
  family({
    ...
    priorityScore: 82,
    positiveSignals: ['forced labour', 'forced labor', 'modern slavery', 'child labour', 'child labor', 'human rights abuse', 'worker exploitation', 'exploitative labour'],
    antiSignals: ['ddos', 'dark web credentials', 'website flood', 'single source', 'supplier concentration'],
    requiredSignals: ['forced labour', 'forced labor', 'modern slavery', 'child labour', 'child labor', 'human rights'],
  ...
  family({
    ...
    requiredSignals: ['greenwashing', 'sustainability disclosure', 'climate disclosure', 'claim substantiation'],
  ...
  family({
    ...
    positiveSignals: ['perimeter breach', 'site intrusion', 'intrusion into facility', 'perimeter failure', 'badge control lapse', 'visitor management failure', 'facility access lapse'],
    antiSignals: ['ddos', 'credential theft', 'greenwashing'],
  ...
  family({
    ...
    positiveSignals: ['ot resilience failure', 'industrial control weakness', 'ics instability', 'scada weakness', 'site systems instability', 'industrial control instability', 'control room instability', 'ics outage', 'scada disruption'],
