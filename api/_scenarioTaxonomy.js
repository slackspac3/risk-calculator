...
const DATA_DISCLOSURE_EXPLICIT = [
  ...
  signal('misrouted disclosure', 'strong'),
  signal('misdirected disclosure', 'strong'),
  signal('wrong recipient disclosure', 'strong'),
  signal('personal data sent to the wrong recipient', 'strong'),
  signal('exposing bank details to the wrong employees', 'strong'),
  signal('bank details exposed to the wrong employees', 'strong'),
  signal('bank details to the wrong employees', 'strong'),
  signal('misroutes salary payments', 'medium'),
